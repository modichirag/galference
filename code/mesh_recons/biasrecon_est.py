...
import mesh_composite as mcomp
##
...
tf.flags.DEFINE_string("fpath", "./tmp/", "suffix for the folder name")
...
def main(_):
    ...
    fpos = tools.readbigfile('../data/L0400_N0128_S0100_05step/dynamic/1/Position/')
    
    hpos = tools.readbigfile('../data/L0400_N0512_S0100_40step/FOF/PeakPosition//')[1:int(bs**3 *numd)]
    hmass = tools.readbigfile('../data/L0400_N0512_S0100_40step/FOF/Mass//')[1:int(bs**3 *numd)].flatten()
